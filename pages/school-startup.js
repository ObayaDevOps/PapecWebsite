...
export default function SchoolStartUpPageComponent({ servicesSchoolStartUpPageContent }) {
  console.log(servicesSchoolStartUpPageContent);

  return (
    <Box>
      <Head>
        <title>{servicesSchoolStartUpPageContent.title} | People and Potential Consultancy</title>
      ...
      <Box py={6} bgGradient='linear(to-br, #e5e5f7, whiteAlpha.100)'>
        ...
        >
          <Flex
            ...
            <CallToAction content={servicesSchoolStartUpPageContent.callToAction} />
